...
export const categories = ["Casques", "Enceintes", "Montres", "Ecouteurs", "Souris", "Decoration"];
...
export const ourSpecsData = [
    { title: "Livraison rapide", description: "Recevez vos commandes rapidement, partout au Senegal.", icon: SendIcon, accent: '#05DF72' },
    { title: "Retour sous 7 jours", description: "Un souci avec votre article ? Retour possible sous 7 jours.", icon: ClockFadingIcon, accent: '#FF8904' },
    { title: "Support 24/7", description: "Notre equipe vous accompagne a tout moment.", icon: HeadsetIcon, accent: '#A684FF' }
]
