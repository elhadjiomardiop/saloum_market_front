            ...
            <div className="max-sm:mt-6">
                {
                    sidebarLinks.map((link, index) => (
                        <Link key={index} href={link.href} className={`relative flex items-center gap-3 text-slate-500 hover:bg-orange-50 p-2.5 transition ${isActiveLink(link.href) && 'bg-slate-100 sm:text-slate-600'}`}>
