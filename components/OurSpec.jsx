    ...
    return (
        <div className='px-4 sm:px-6 my-16 sm:my-20 max-w-6xl mx-auto'>
            <Title
                ...
                description="Un service rapide, fiable et securise pour une experience d'achat simple et sans stress."
            />

            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7 gap-y-10 mt-16 sm:mt-20'>
