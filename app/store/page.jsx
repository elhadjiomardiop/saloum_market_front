...
export default function Dashboard() {
    ...
    const dashboardCardsData = [
        { title: 'Total produits', value: dashboardData.totalProducts, icon: ShoppingBasketIcon },
        { title: 'Chiffre d affaires', value: currency + dashboardData.totalEarnings, icon: CircleDollarSignIcon },
        { title: 'Total commandes', value: dashboardData.totalOrders, icon: TagsIcon },
        { title: 'Total avis', value: dashboardData.ratings.length, icon: StarIcon },
    ]
